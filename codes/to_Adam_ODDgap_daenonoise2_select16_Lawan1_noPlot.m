...
[selectedIdx, selectedFreq, bestGap, gapVec] = pickSpreadFaithfulRows(faithfulIdx, K);
...
function [selectedIdx, selectedFreq, bestGap, gapVec] = pickSpreadFaithfulRows(faithfulIdx, K)
