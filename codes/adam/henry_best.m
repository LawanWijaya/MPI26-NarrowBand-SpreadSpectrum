function sets = henry_best(M,score,snum,kdim,pickalg)
% HENRY_BEST generates a codebook from given a given feasible. Everything
% below this comment block was take directly from Henry's Github branch on
% 6/28/26 and has not been modified.
%
