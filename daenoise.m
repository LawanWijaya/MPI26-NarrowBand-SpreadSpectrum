...
% % % Then plot the result:
%
% bandplot(plotset,snr,n);

maxrun = 10;
% Fourth plot: F vs bandwidth, no noise.
for snr = -3:-6:-9
% for snr = -3:-3
    ...
    nbandplot(noisyplot,snr,n,maxrun);
...
function bandplot(plotset,snr,n)
...
% Then use the string in the title and y-axis:
tstring = append(fstring,' vs. bandwidth, $\omega_{\rm w}=10$ Hz, ');
...
function nbandplot(plotset,snr,n,maxrun)
